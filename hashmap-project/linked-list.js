class Node {
  ...
  class LinkedList {
      ...
      append(key, value){
          if(this.head.key === null) this.head = new Node(key, value)
          else { 
     ...
     prepend(key, value){
         if(this.head.key === null) this.head = new Node(key, value)
         else this.head = new Node(key, value, this.head)
     }
      ...
      insertAt(index, key, value){
          const length = this.size();
          if(index === 1) this.prepend(key, value);
          else if(index === (length+1)) this.append(key, value)
          ...
          prevNode.next = new Node(key, value, nextNode)
          }
          return
      }
